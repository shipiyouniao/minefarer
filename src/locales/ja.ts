...
export const jaMessages: MessageCatalog = {
  'recollection.tidal': '潮の水門',
  'recollection.tidal-note': '水門を切り替えて潮の水路を止め、各ポンプをつなごう。',
  'recollection.river': '水上航行',
  'recollection.river-note': '毎回変わる水域を調べ、航行と係留で出口への航路を開こう。',
  'recollection.tidal-locked': '「葦の水路」クリアで解放',
  'recollection.river-locked': '「反圧の入り江」クリアで解放',

  'pressure.help': '船の進め方',
  'pressure.wait': '一マス流れる',
  'pressure.raft': '小舟 · 押して乗る',
  'pressure.water': '航路',
  'pressure.board':
    '桟橋の船を押して乗船。錨を下ろすと周囲8マスを調べられます。数字は周囲の機雷の数です。',
  'pressure.ride':
    '錨を上げ、判明した安全な水マスを選ぼう。下流か横へ進める。逆流には別の航路が必要だ。',
  'pressure.land': '係留場所の隣で錨を下ろし、そこを押して綱を結ぼう。新しい帰還地点になる。',
  'pressure.static': '水雷と数字は動かない。',
  'pressure.objective': '航路を開き、綱を結んで出口へ。',
  'pressure.detail': '旧渡し場から出航し、入り江の水雷を調べて島の係留場所をつなごう。',
  'pressure.floor-1': '第1層 · 水の下の道',
  'pressure.floor-2': '第2層 · 島の間を抜けて',
  'pressure.floor-3': '第3層 · 帰りの綱',
  'pressure.entry-1': '漕ぐのは待って。水の中にも地雷がある。錨を下ろして、近くの数字を見よう。',
  'pressure.entry-2': '分かった。まず安全な航路だね。',
  'pressure.basin-1': '島の周りで流れが曲がってる。帰りのために綱を残しておこう。',
  'pressure.basin-2': '先にあそこへ綱を結ぶよ。帰りに遠回りしなくて済む。',
  'pressure.boat-1': 'ここは水路が入り組んでる。行き止まりなら綱を巻いて戻ろう。',
  'pressure.boat-2': '大丈夫。帰り道は残してある。',
  'pressure.end-1': '全部の綱を結べた。次は安心して渡れそうだね。',
  'pressure.end-2': 'やっと腕を休められるよ。けっこう漕いだね。',
  'pressure.title': '反圧の入り江',
  'pressure.task': '島を結ぶ航路',
  'pressure.progress': '係留 {count}/{total}',
  'pressure.raise': '錨を上げる',
  'pressure.lower': '錨を下ろす',
  'pressure.haul': '綱で戻る',
  'pressure.haul-hint': '通った航路を綱で戻り、最後に結んだ場所へ帰る。数字と印はそのまま残る。',
  'pressure.sailing': '下流か横へ進もう。近くの水マスを調べるなら錨を下ろそう。',
  'pressure.sounding': '船が止まった。周囲八マスを調べられる。進むときは錨を上げよう。',
  'pressure.secure-hint': '隣で錨を下ろし、係留場所を押して帰りの綱を結ぼう。',
  'pressure.secured': '係留済み',
  'pressure.exit': '綱を結べた。出口の桟橋へ進もう。',
  'pressure.north': '北向きの流れ',
  'pressure.east': '東向きの流れ',
  'pressure.south': '南向きの流れ',
  'pressure.west': '西向きの流れ',
  'pressure.guide-board': '乗船して調べる',
  'pressure.guide-sail': '流れを使う',
  'pressure.guide-moor': '錨を下ろして結ぶ',
  'pressure.blocked': '今はそこへ進めない。流れを確認するか、綱で戻って別の水路を探そう。',
  ...
  'current.feed': '水門：{row}行{column}列・{branch}支流',
  'current.title': '潮流と安定域',
  'current.guide':
    '水門を切り替えると、未接続の区域が矢印の向きに縦または横へ1マス循環します。人物・機雷・印も移動し、数字は更新されます。壁・装置・出入口は固定です。',
  'current.legend':
    '青緑の区域は固定、砂色の区域は移動します。濃いマスは未開放です。各区域の先頭に支流と方向を表示します。',
  'current.held': '安定域：接続中は固定',
  'current.moving': '潮流域：切替後に未接続なら矢印方向に循環',
  ...
  'ferry.entry-1': 'あの石、さっきは別の場所にあった。水門を動かすと反対側の地面も流れる。',
  'ferry.entry-2':
    'こちらに接続すれば固定できる。切り替える前に矢印を見よう。前の数字のまま歩くのは危ない。',
  'ferry.entry-3': '旗も石と一緒に動く。こちらの水位を記録したら、反対側を試そう。',
  'ferry.banks-1': 'こちらの目盛りは低いのに、向こう岸は高い。',
  'ferry.banks-2': '川全体が同時に満ち引きしてるんじゃない。区間ごとに何かが水を押してる。',
  'ferry.banks-3': '流れる範囲が広くなった。調べたい岸を固定してから、水位計を読もう。',
  'ferry.gate-1': '聞いて。また水門の向こうから。野営地で聞いた水音と同じだ。',
  'ferry.gate-2': '両岸が逆方向に流れる。前と同じ渡り方では駄目だ。矢印をよく見よう。',
  ...
  'ferry.end-3': 'この道の先が古い渡し場だ。帰りは桟橋から直接通れる。もう水路を回る必要はない。',
}
