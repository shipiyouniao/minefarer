...
export const jaMessages: MessageCatalog = {
  'pressure.help': '渡り方',
  'pressure.wait': '潮を待つ',
  'pressure.raft': '筏 · 乗り込む',
  'pressure.water': '川 · 筏で渡る',
  'pressure.board': '岸まで安全な道を探し、筏を押して乗り込もう。',
  'pressure.ride': '乗ったら「潮を待つ」で次の岸へ進もう。',
  'pressure.land': '岸に着いた。開いている岸のマスを押して降り、錨を探そう。',
  'pressure.static': '地雷と数字は動かない。潮待ちで動くのは筏だけで、岸のマスは開かない。',
  'pressure.objective': '筏で対岸へ渡り、錨を見つけて出口へ。',
  'pressure.detail': '旧渡し場で筏に乗り、各地の錨を見つけて渡し場をつなごう。',
  'pressure.floor-1': '第1層 · 筏に乗ろう',
  'pressure.floor-2': '第2層 · 降りる岸を選ぶ',
  'pressure.floor-3': '第3層 · 崩れた岸を回る',
  'pressure.entry-1': '橋が落ちている。あの筏なら、向こうへ渡れそうだ。',
  'pressure.entry-2': 'まず岸までの道を探すよ。それから乗ろう。',
  'pressure.basin-1': '今度は四つの停泊場所がある。筏の行き先を見てから降りよう。',
  'pressure.basin-2': '上の岸は通れない。筏で下へ回るよ。',
  'pressure.boat-1': '両岸とも一部が崩れている。錨を見つけて、使える岸を確かめよう。',
  'pressure.boat-2': '分かった。止まる順番は覚えたよ。',
  'pressure.end-1': 'ロープを結べた。これで両岸を行き来できる。',
  'pressure.end-2': '上流にも壊れた橋がある。次はそちらを見に行こう。',

  'pressure.title': '反圧の入り江',
  'pressure.task': '壊れた橋を渡る',
  ...
  'current.legend':
    '青緑は固定岸、砂色は移動岸。濃いマスは未開放、淡いマスは開放済みです。各行の先頭に支流と方向を表示します。',
