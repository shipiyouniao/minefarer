...
export const zhMessages: MessageCatalog = {
  'pressure.help': '怎么摆渡',
  'pressure.wait': '等潮水',
  'pressure.raft': '木筏 · 走上去搭乘',
  'pressure.water': '河道 · 需要搭乘木筏',
  'pressure.board': '先找到岸边的路，再点木筏上船。',
  'pressure.ride': '上船后点“等潮水”，木筏会带你到下一处停靠点。',
  'pressure.land': '靠岸了。点岸上已翻开的格子下船，再去找船锚。',
  'pressure.static': '雷和数字都留在原地。等潮水只会移动木筏，不会替你揭开岸上的格子。',
  'pressure.objective': '搭木筏到对岸，找到船锚，再走到出口。',
  'pressure.detail': '去旧渡口，搭木筏过河。找到各处船锚，把这段渡口重新连起来。',
  'pressure.floor-1': '第一层 · 搭个顺风船',
  'pressure.floor-2': '第二层 · 别下错岸',
  'pressure.floor-3': '第三层 · 绕过断岸',
  'pressure.entry-1': '桥已经断了。等那只木筏靠岸，我们坐它过去。',
  'pressure.entry-2': '我先清出一条到岸边的路。',
  'pressure.basin-1': '这次有四个停靠点。先看木筏往哪边走，别急着下船。',
  'pressure.basin-2': '上面这段岸走不通了，我坐船绕到下面。',
  'pressure.boat-1': '两边都有塌掉的地方。先去找船锚，回来时就知道在哪儿靠岸了。',
  'pressure.boat-2': '好，我记住停靠的顺序了。',
  'pressure.end-1': '缆绳都系好了。这下两岸的人能来往了。',
  'pressure.end-2': '上游还有一段断桥，我们接着往那边看看。',

  'pressure.title': '回压湾',
  'pressure.task': '断桥摆渡',
  'pressure.progress': '船锚 {count}/{total}',
  ...
  'current.legend':
    '青绿色：稳流区。浅沙色：潮移区。深色格尚未翻开，浅色格已翻开；每行起点标出支流和方向。',
