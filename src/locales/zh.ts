...
export const zhMessages: MessageCatalog = {
  'recollection.tidal': '潮汐水闸',
  'recollection.tidal-note': '转动水闸，固定需要经过的潮道，再接通各处抽水机。',
  'recollection.river': '水上航行',
  'recollection.river-note': '在随机水域里探雷、行船和系缆，清出通往出口的航道。',
  'recollection.tidal-locked': '通关「苇间水道」后解锁',
  'recollection.river-locked': '通关「回压湾」后解锁',

  'pressure.help': '怎么行船',
  'pressure.wait': '顺流一格',
  'pressure.raft': '小船 · 点击上船',
  'pressure.water': '航道',
  'pressure.board': '点击码头的小船上船。落锚后可以探查船边八格，数字表示周围的雷数。',
  'pressure.ride': '起锚后，点击已探明的水格行船。可以顺流或横渡，逆流要绕路。',
  'pressure.land': '靠近系缆点，落锚后点击它系好缆绳。这里会成为新的回航点。',
  'pressure.static': '水雷和数字不会移动。',
  'pressure.objective': '清出航道，系好缆绳，再到出口靠岸。',
  'pressure.detail': '从旧渡口出发，清理回压湾的水雷，重新接通岛边的系缆点。',
  'pressure.floor-1': '第一层 · 水下的路',
  'pressure.floor-2': '第二层 · 分流绕岛',
  'pressure.floor-3': '第三层 · 留一条回航线',
  'pressure.entry-1': '别急着划，水里也有雷。先把锚放下，看看船边的数字。',
  'pressure.entry-2': '明白，先找出能走的水路。',
  'pressure.basin-1': '水流在岛边拐弯了。顺着过去容易，想回来得先留好缆绳。',
  'pressure.basin-2': '我先靠近那个系缆点，免得绕一大圈。',
  'pressure.boat-1': '这边的水路分得更细。走不通就收缆退回来，别硬闯。',
  'pressure.boat-2': '放心，回来的路还在。',
  'pressure.end-1': '缆绳都系好了。下次过河，不用再摸黑找路了。',
  'pressure.end-2': '总算能歇歇手了。划这么一圈可不轻松。',
  'pressure.title': '回压湾',
  'pressure.task': '接通岛间航路',
  'pressure.progress': '系缆 {count}/{total}',
  'pressure.raise': '起锚',
  'pressure.lower': '落锚',
  'pressure.haul': '收缆回航',
  'pressure.haul-hint': '收缆会沿已经走过的航线，退回最近系好的缆绳处。探明的数字和标记都会保留。',
  'pressure.sailing': '顺流或横渡；想探查船边的水格，先落锚。',
  'pressure.sounding': '船已停稳。可以探查周围八格；要移动时再起锚。',
  'pressure.secure-hint': '落锚后点击系缆点，接上回航的绳索。',
  'pressure.secured': '缆绳已系好',
  'pressure.exit': '缆绳齐了。到出口码头靠岸。',
  'pressure.north': '水流向上',
  'pressure.east': '水流向右',
  'pressure.south': '水流向下',
  'pressure.west': '水流向左',
  'pressure.guide-board': '上船探查',
  'pressure.guide-sail': '借水流选路',
  'pressure.guide-moor': '落锚接缆',
  'pressure.blocked': '这里暂时到不了。看看水流方向，或收缆换条路。',
  ...
  'current.feed': '水闸：第 {row} 行，第 {column} 列 · {branch} 支路',
  'current.title': '潮汐与稳流',
  'current.guide':
    '切换水闸后，未接通的区域沿箭头横移或纵移一格。人物、雷和标记一起移动，数字重新计算；墙、机关和出入口不动。',
  'current.legend':
    '青绿色区域保持不动，浅沙色区域会移动。深色格尚未翻开；每片区域的起点标出支路和方向。',
